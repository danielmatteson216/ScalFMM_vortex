...
int main(int argc, char* argv[]){
    ...
    using GroupCellClass     = FUnifCell<FReal, 7>;
    using GroupCellUpClass   = typename FUnifCell<FReal, 7>::multipole_t;
    using GroupCellDownClass = typename FUnifCell<FReal, 7>::local_expansion_t;
    ...
    if(FParameters::existParameter(argc, argv, LocalOptionNoValidate.options) == false){
        ...
        groupedTree.forEachCellLeaf<FP2PGroupParticleContainer<FReal> >([&](GroupCellSymbClass* gsymb, GroupCellUpClass* gmul, GroupCellDownClass* gloc, FP2PGroupParticleContainer<FReal> * leafTarget){
