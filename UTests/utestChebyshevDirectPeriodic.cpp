            ...
            for(int idxLevel = NbLevels-1 ; idxLevel >= 2 ; --idxLevel){
                while(true){
                    ...
                    for(int idx = 0; idx < cl->getVectorSize(); ++idx){
                        accurater.add(cl->getMultipoleData().get(0)[idx],
                                      clnonper->getMultipoleData().get(0)[idx]);
                    }
            ...
            for(int idxLevel = NbLevels-1 ; idxLevel >= 1 ; --idxLevel){
                ...
                do {
                    ...
                    if(clnonper){
                        ...
                        for(int idx = 0; idx < cl->getVectorSize(); ++idx){
                            accuraterLocal.add(cl->getLocalExpansionData().get(0)[idx],
                                               clnonper->getLocalExpansionData().get(0)[idx]);
                        }
