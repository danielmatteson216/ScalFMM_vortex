...
template <class FReal, class SymbolCellClass, class PoleCellClass,
          class LocalCellClass, class GroupAttachedLeafClass>
class FGroupTreeDyn {
public:
    typedef GroupAttachedLeafClass BasicAttachedClass;
    typedef FGroupOfParticlesDyn ParticleGroupClass;
    typedef FGroupOfCellsDyn<SymbolCellClass,PoleCellClass,LocalCellClass> CellGroupClass;
