...
#ifndef FFMMALGORITHMNEWTASK_HPP
#define FFMMALGORITHMNEWTASK_HPP
...
class FFmmAlgorithmNewTask : public FAbstractAlgorithm, public FAlgorithmTimers {
...
public:
          ...
          OctreeHeight(tree->getHeight()), leafLevelSeparationCriteria(inLeafLevelSeperationCriteria)
    {
        ...
        {
            #pragma omp critical (InitFFmmAlgorithmNewTask)
            {
